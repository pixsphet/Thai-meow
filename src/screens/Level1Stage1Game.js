...
const Level1Stage1Game = ({ navigation, route }) => {
  const { lessonId = 1, level = 'Beginner', stageTitle = 'ด่านที่ 1' } = route.params || {};
  ...
  // Level 1 Stage 1 - Basic Greetings
    ...
    if (currentQuestion < gameData.length - 1) {
      ...
      Alert.alert(
        ...
        [
          ...
          { text: 'ต่อไปด่านที่ 2', onPress: () => navigation.navigate('Level1Stage2Game') },
      ...
      <View style={styles.container}>
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.loadingContainer}>
            ...
            />
            <Text style={styles.loadingText}>กำลังโหลดด่านที่ 1...</Text>
          </View>
        </SafeAreaView>
      </View>
    );
      ...
      <View style={styles.container}>
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.gameOverContainer}>
            ...
            />
            <Text style={styles.gameOverText}>ด่านที่ 1 จบ!</Text>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerInfo}>
            <Text style={styles.headerTitle}>Level 1 - ด่านที่ 1</Text>
            <Text style={styles.headerSubtitle}>คำทักทายพื้นฐาน</Text>
          </View>
...
export default Level1Stage1Game;
